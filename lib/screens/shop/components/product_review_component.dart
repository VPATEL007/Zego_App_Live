                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(review.reviewer.validate(), style: boldTextStyle(size: 14), maxLines: 1, overflow: TextOverflow.ellipsis).expand(),
                                        Text(convertToAgo(review.dateCreated.validate()), style: secondaryTextStyle(size: 12)),
                                      ],
                                    ),
                                    2.height,
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        if (review.reviewer == appStore.loginFullName)
                                          Text('${language.edit}', style: secondaryTextStyle(color: context.primaryColor, size: 12)).onTap(() {
                                            showInDialog(
                                              context,
